      					...
      					<div class="card-body">
        					...
        					<div>
  								<div id="myCarousel<%= i %>" class="carousel slide" data-ride="carousel" data-interval="false">
									...
									<a class="left carousel-control" style="width:30px" href="#myCarousel<%= i %>" data-slide="prev">
										<span class="glyphicon glyphicon-chevron-left"></span>
										<span class="sr-only">Previous</span>
									</a>
									<a class="right carousel-control" style="width:30px" href="#myCarousel<%= i %>" data-slide="next">
